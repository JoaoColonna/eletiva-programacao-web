...
<body class="container">
    ...
    ?>
    <a href="insert_professor.php" class="btn btn-success me-md-3">Inserir</a>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?= $row['Telefone'] ?></td>
                        <td><?= $row['Email'] ?></td>
                        <td><?= consultarAluno($row['Aluno'])[0]['nome']?></td>
                        <td>
                            <div class="btn-group mx-auto" role="group" aria-label="Ações">
                                <a href="editar_professor.php?id=<?=$row['Id']?>" class="btn btn-primary"><button type="button">✏️</button></a>
                                <a href="delete_professor.php?id=<?= $row['Id'] ?>" class="btn btn-danger"><button type="button">🗑️</button></a>
                            </div>
                        </td>
                    </tr>
            <?php
